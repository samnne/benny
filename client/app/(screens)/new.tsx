...
const NewReceipt = () => {
    ...
    return (
      <SafeAreaView className="flex-1 bg-white  items-center justify-center px-8">
        ...
        <Text className="font-nunito-medium text-base text-text/60 text-center mt-3 mx-6 leading-6">
          Allow Benny to access your camera. We use it only to parse receipts, nothing more!
        </Text>
        ...
        <View className="absolute bottom-10 items-center">
          <Text className="font-nunito text-xs text-text/40 ">
            View our{" "}
            <Link href="https://market-quad.com/privacy" className="text-primary dark:text-primary-dark">
              Privacy Policy
            </Link>
            {" "}and{" "}
            <Link href="https://market-quad.com/tos" className="text-primary dark:text-primary-dark">
              Terms of Service
            </Link>
          </Text>
        </View>
  ...
  return (
    <View className="flex-1 justify-center bg-black">
      ...
      {/* Controls overlay */}
      <SafeAreaView className="absolute bottom-0 left-0 right-0 pb-6 items-center gap-4" edges={["bottom"]}>
        ...
        <View className="flex-row items-center justify-center gap-10">
          ...
          <TouchableOpacity
            ...
            style={{ shadowColor: "#fff", shadowOpacity: 0.3, shadowRadius: 12 }}
          >
